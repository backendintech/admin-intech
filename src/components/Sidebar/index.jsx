    ...
    <>
      <aside className="bg-[#ffffff] border-e-[1px] border-greyPrimary xl:w-[20%] lg:w-[30%]  pt-6 h-screen hidden lg:block">
        ...
        <ul className={"mt-20 flex flex-col"}>
          ...
          <li>
            <NavLink
              active={checkIsActive("products")}
              title={"Products"}
              href={"/products"}
              icon={<ItemsIcon active={checkIsActive("products")} />}
            />
          </li>
          <li>
            <NavLink
      ...
      {show && (
        <div className="flex fixed top-0 z-[100] w-full bg-black bg-opacity-50 h-screen block lg:hidden">
            ...
            <ul className={"mt-20 flex flex-col"}>
              ...
              <li>
                <NavLink
                  ...
                  href={"/categories"}
                  icon={
                    <CategoryRounded active={checkIsActive("categories")} />
                  }
                />
              </li>
            </ul>
