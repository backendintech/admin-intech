    ...
    <section className="flex flex-col pb-6 md:pb-0 md:flex-row h-screen bg-whiteSecondary items-center w-full gap-5">
      <div className="w-full md:w-1/2 h-full">
        <img
          ...
          src="https://cmmonline.com/wp-content/uploads/10-23-2023-news-Document-Management-System-DMS-Online-Document-Database-and-automated-processes-1413938706-feat.jpg"
          alt="intro"
        />
      </div>
      <div className="w-full md:w-1/2 flex justify-center">
        <form className="md:bg-slate-100 md:border-[1px] md:border-slate-300 md:px-10 xl:px-52 md:rounded-3xl md:py-20 flex flex-col items-start " onSubmit={handleLoginAdmin}>
          <div className="flex justify-center w-full mb-10">
            <h1 className="font-bold text-2xl md:text-3xl w-full text-center">Login as Admin</h1>
          </div>
